...
// include: /tmp/tmp49hliuto.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build_web/robocode/game.data';
...
Module['FS_createPath']("/resources", "robocode", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build_web/robocode/game.data');

      };
      Module['addRunDependency']('datafile_build_web/robocode/game.data');
